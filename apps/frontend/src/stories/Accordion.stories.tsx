...
export const Default: Story = {
  render: () => (
    <Accordion
      type="single"
      collapsible
      className="w-[400px] border-[3px] border-ink rounded-xl shadow-comic-sm"
    >
      <AccordionItem value="item-1" className="border-b-2 border-ink px-4">
        ...
        <AccordionContent className="text-sm font-medium opacity-80">
          Uma aplicação web self-hosted que converte mangás de online para formatos compatíveis com
          Kindle.
        </AccordionContent>
      </AccordionItem>
