...
describe('DownloadOnlyQueueService', () => {
  let mockQueue: ReturnType<typeof makeMockQueue>
  let queueService: DownloadOnlyQueueService
  ...
  it('getJob delega para queue.getJob', async () => {
